...
import static org.academiadecodigo.whiledlings.whiledbits.sound.PathNotes.*;

public class NotesPadController extends OneTouchPadController {

    protected NotesPadController(Controller parent) {
        super(parent);
    }
